...
function sum(sum1, sum2) {
  var sum = sum1 + sum2;
  var message = 'The sum of ' + sum1 + ' and ' + sum2 + ' is ' + sum + '.';
  return [sum, message];
}
...
function multiply(product1, product2){
  ...
  var message = 'The product of ' + product1 + ' and ' + product2 + ' is ' + product + '.';
...
// Write your code here
function sumAndMultiply(p1, p2, p3) {
  var sum = p1 + p2 + p3;
  var product = p1 * p2 * p3;
  return[sum, product, p1 + ' and ' + p2 + ' and ' + p3 + ' sum to ' + sum + '.', 'The product of ' + p1 + ' and ' + p2 + ' and ' + p3 + ' is ' + product + '.'];
}
